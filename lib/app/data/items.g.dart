...
Item _itemDeserialize(
  ...
  final object = Item(
    description: reader.readStringOrNull(offsets[0]) ?? 'A simple sowrd.',
    name: reader.readStringOrNull(offsets[1]) ?? 'sowrd',
    price: reader.readStringOrNull(offsets[2]) ?? '0',
    quantity: reader.readLongOrNull(offsets[3]) ?? 1,
    type: reader.readStringOrNull(offsets[4]) ?? '道具',
    weight: reader.readDoubleOrNull(offsets[6]) ?? 0.0,
  );
...
P _itemDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'A simple sowrd.') as P;
    case 1:
      return (reader.readStringOrNull(offset) ?? 'sowrd') as P;
    case 2:
      return (reader.readStringOrNull(offset) ?? '0') as P;
    case 3:
      return (reader.readLongOrNull(offset) ?? 1) as P;
    case 4:
      return (reader.readStringOrNull(offset) ?? '道具') as P;
    case 5:
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'price',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'price',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'price',
        value: '',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'price',
        value: '',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'uniqueId',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'uniqueId',
        value: '',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> uniqueIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'uniqueId',
        value: '',
